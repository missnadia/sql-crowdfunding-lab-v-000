...
"SELECT projects.title, (SUM(pledges.amount) - projects.funding goal) AS remaining FROM projects INNER JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.title HAVING remaining >= 0;"
end
